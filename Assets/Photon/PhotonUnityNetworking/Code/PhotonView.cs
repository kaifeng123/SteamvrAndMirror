...
namespace Photon.Pun
{
    ...
    public class PhotonView : MonoBehaviour
    {
        ...
        /// <summary>
        /// 独立联网协议,不受单个玩家约束,不属于任何玩家
        /// 所有玩家都可以发送协议,修改协议
        /// </summary>
        [FormerlySerializedAs("isIndependent")]
        ...
        protected internal void SerializeComponent(Component component, PhotonStream stream, PhotonMessageInfo info)
        {
            ...
            {
                Debug.Log("Observed scripts have to implement IPunObservable. "+ component + " does not. It is Type: " + component.GetType(), component.gameObject);
            }
        }
